...
A princípio, os dados ausentes serão mantidos como "NA", com o objetivo de preservar ao máximo a integridade da base de dados original, evitando a exclusão de observações ou a inferência de valores sem justificativa. Nos casos em que a presença de valores ausentes impossibilitar a realização de determinada análise, será avaliada a exclusão apenas das observações com "NA" nas variáveis envolvidas, mantendo-se os demais registros da base.
