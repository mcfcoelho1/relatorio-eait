...
Agora, de forma similar a anterior, utilizando a estrutura obtida com `split()`, aplicou-se a função `sapply()` para calcular a resistência média à compressão de cada tipo de concreto. Entretanto, o objeto de retorno, agora é um vetor numérico, estrutura bem mais simplificada.
