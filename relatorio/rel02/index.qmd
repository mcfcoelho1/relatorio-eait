...
Após o tratamento da base de dados, procedeu-se à análise estatística descritiva da resistência à compressão dos corpos de prova.

Para a resistência média geral foi utilizado a função `mean()`
