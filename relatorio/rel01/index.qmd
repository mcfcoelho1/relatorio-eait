...
- Apresentar os fundamentos da linguagem R, incluindo sintaxe, estruturas de dados, funções, controles, pacotes e ambientes;
- Revisar os principais conceitos da Estatística Descritiva e a classificação das variáveis;
- Abordar a organização, tabulação e representação gráfica dos dados;
- Apresentar e interpretar medidas de posição, dispersão, assimetria e curtose;
- Utilizar o pacote leem para realizar a análise descritiva de uma base de dados;
- Organizar e representar os dados, calcular as principais medidas estatísticas e discutir os resultados obtidos.
