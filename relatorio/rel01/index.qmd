...
- Apresentar os principais fundamentos da linguagem R abordados no curso R Básico 2024 – Sintaxe e Semântica;
- Compreender conceitos relacionados a objetos, estruturas de dados, funções, estruturas de controle, pacotes, ambientes e interfaces no R;
- Revisar os principais conceitos de Estatística Descritiva apresentados no livro EPAEC;
- Estudar os conceitos de assimetria e curtose como complemento à descrição de distribuições de dados;
- Organizar um banco de dados e utilizar o pacote leem para realizar a tabulação e representação gráfica dos dados;
- Calcular e interpretar medidas de posição, dispersão, assimetria e curtose;
- Discutir os resultados encontrados, relacionando as medidas e representações obtidas às características observadas no conjunto de dados.  
...
$$
Em que $i$ funciona como índice e $n$ indica o limite superior da soma. Dessa forma, a expressão representa a soma dos valores de $X_i$, desde $i = 1$ até $i = n$.
...
$$
representa o quadrado da soma dos valores.
